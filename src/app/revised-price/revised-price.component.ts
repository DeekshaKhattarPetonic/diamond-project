...
import { ReviewChangesNewComponent } from '../review-changes-new/review-changes-new.component';
...
@Component({
  ...
  standalone: true,
  imports: [MultiSelectModule, TableModule, MatSelectModule, MatFormFieldModule,FilterTablePipe, PaginatorModule, FooterComponent, DialogModule, MatIconModule, DynamicDialogModule, CalendarModule, ChartModule, MatTabsModule, MatRadioModule, DropdownModule, FormsModule, CommonModule, ReactiveFormsModule, CheckboxModule, HeaderComponent],
...
export class RevisedPriceComponent {
  ...
  openReviewModal(){
    const dialogRef = this.dialog.open(ReviewChangesNewComponent, {
      width: '80vw',
      data: {
        head: 'Changes Saved',
        message: 'The changes have been saved successfully.',
